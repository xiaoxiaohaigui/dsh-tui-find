...
- **Scene wiring (real host renderer)**: preview key layering and typing swallow, circular n/N jumps and copy, PgDn page math, narrow single-row header truncation, help panel toggling.
